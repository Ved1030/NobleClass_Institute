...
async function seed(): Promise<void> {
  ...
  ensureFile('courses', [
    { id: 1, title: 'Std 8th Coaching (State Board & CBSE)', description: 'Concept-focused learning for State Board and CBSE students with regular assessments, doubt-solving sessions, and performance tracking.', class: '8', category: 'Programs', subjects: 'Mathematics,Science,English', duration: 'Academic Year', badge: 'Popular', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 2, title: 'Std 9th Coaching (State Board & CBSE)', description: 'Advanced preparation for State Board and CBSE students with detailed subject understanding, exam strategies, and comprehensive curriculum coverage.', class: '9', category: 'Programs', subjects: 'Mathematics,Science,English', duration: 'Academic Year', badge: 'Advanced', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
    { id: 3, title: 'Std 10th Coaching (State Board & CBSE)', description: 'Board exam-focused preparation for State Board and CBSE students with revision programs, intensive practice sessions, and mock tests.', class: '10', category: 'Programs', subjects: 'Mathematics,Science,English', duration: 'Academic Year', badge: 'Board Focus', createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  ]);
