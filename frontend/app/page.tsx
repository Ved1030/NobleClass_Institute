...
const testimonials = [
  ...
  { id: 2, name: 'Mrs. Deshmukh', label: 'Parent', content: 'My child\'s confidence and academic performance improved significantly after joining Labbdhi\'s Academy. The personal attention makes a big difference.', rating: 5, type: 'parent', initials: 'MD' },
...
const faqs = [
  { q: 'What coaching does Labbdhi\'s Academy offer?', a: 'Labbdhi\'s Academy provides coaching for students of Std 8th, 9th & 10th (State Board & CBSE) in Mathematics, Science, and English. Our programs focus on building strong concepts and academic excellence.' },
  { q: 'Where is Labbdhi\'s Academy located?', a: 'Labbdhi\'s Academy is located near Shreyas Cinema, Ghatkopar West, Mumbai, Maharashtra.' },
...
const Home: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
            <div>
              <span className="section-subtitle">About Labbdhi\'s Academy</span>
              ...
              <p className="text-noble-dark/60 text-lg leading-relaxed mb-6">
                Labbdhi\'s Academy has been guiding students since 2007 with a focus on academic excellence, concept clarity, and individual attention. We provide coaching for students of Std 8th, 9th & 10th (State Board & CBSE), helping them strengthen fundamentals and achieve outstanding academic results.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                <Link href="/about" className="btn-primary">Know More About Labbdhi\'s <ArrowRight className="w-4 h-4" /></Link>
              </div>
            </div>
            ...
            >
              <div className="relative h-[520px] rounded-2xl overflow-hidden shadow-lg shadow-black/5">
                <Image
                  ...
                  alt="Students at Labbdhi\'s Academy coaching classes"
                  fill
                  className="object-cover"
                  sizes="380px"
                />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/80 text-lg mb-8">Join Labbdhi\'s Academy Today.</p>
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <SectionHeading subtitle="Reviews" title="What People Say" desc="Hear from our students and parents about their experience at Labbdhi\'s Academy." />
          <div className="grid md:grid-cols-3 gap-6">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div>
              ...
              <p className="text-noble-dark/60 mb-8">Stay informed about admissions, batch schedules, assessments, and important announcements from Labbdhi\'s Academy.</p>
      ...
      <section className="py-20 lg:py-28 bg-noble-light">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <SectionHeading subtitle="Join Us" title="Simple Admission Process" desc="Getting started with coaching at Labbdhi\'s Academy is easy." />
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              { step: '04', title: 'Begin Learning', desc: 'Start your academic journey with Labbdhi\'s Academy.' },
            ].map((item, i) => (
              <motion.div
                key={item.step}
                {...staggeredFade(i)}
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div>
              ...
              <h2 className="section-heading mb-6">Contact <span className="text-noble-blue">Labbdhi\'s Academy</span></h2>
              ...
              <div className="bg-white rounded-[24px] shadow-lg overflow-hidden h-full flex flex-col">
                ...
                <div className="p-6 flex items-center justify-between gap-4 flex-wrap">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                    <p className="font-heading font-bold text-noble-dark">Labbdhi\'s Academy</p>
        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-white/70 text-lg mb-10 max-w-2xl mx-auto">
               Join Labbdhi\'s Academy and build strong foundations for academic success.
            </p>
