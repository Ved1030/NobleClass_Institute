...
const Gallery: React.FC = () => {
  ...
  return (
    <>
      <PageHero title="Gallery" subtitle="A glimpse into life at Labbdhi's Academy — classrooms, events, and the moments that define our journey." breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'Gallery' }]} />
