...
const timeline = [
  { year: '2007', title: 'Foundation', desc: 'Labbdis Academy was founded with a vision to provide quality education and academic guidance to students in Ghatkopar West, Mumbai with a small batch of dedicated learners.' },
...
const About: React.FC = () => {
  return (
    <>
      <PageHero title="About Labbdis Academy" subtitle="A trusted coaching academy since 2007 in Ghatkopar West, Mumbai, providing expert coaching for Std 8th, 9th & 10th students (State Board & CBSE) with concept-based learning and personal attention." breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'About Us' }]} />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-noble-navy/70 leading-relaxed">
                <p>Labbdis Academy has been guiding students since 2007 with a focus on academic excellence, concept clarity, and individual attention. We provide coaching for students of Std 8th, 9th & 10th (State Board & CBSE), helping them strengthen fundamentals and achieve outstanding academic results.</p>
            ...
            <div className="relative">
                <Image src="https://images.unsplash.com/photo-1509062522246-3755977927d7?w=600&h=450&fit=crop" alt="Labbdis Academy - coaching classroom" width={600} height={450} className="rounded-3xl object-cover w-full shadow-2xl shadow-noble-blue/10" />
