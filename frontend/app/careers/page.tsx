...
const Careers: React.FC = () => {
  return (
    <>
      <PageHero title="Careers at Labbdhi's Academy" subtitle="Join our team of passionate educators dedicated to shaping the academic future of students from Std 8th to 10th." breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'Careers' }]} />
