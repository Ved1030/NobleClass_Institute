...
const SuccessStories: React.FC = () => {
  return (
    <>
      <PageHero title="Success Stories" subtitle="Read inspiring stories from our students about their journey with Labbdis Academy." breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'Success Stories' }]} />
