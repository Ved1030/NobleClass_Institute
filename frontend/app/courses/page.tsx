...
const allCourses = [
  { id: 'std-7', title: 'Std 7th Coaching', category: 'Programs', subtitle: 'Foundation Building', description: 'Strong foundation building in Mathematics, Science, English, and core academic subjects with concept-based learning and regular assessments.', subjects: ['Mathematics', 'Science', 'English'], duration: 'Academic Year', students: 'Enrolling Now', rating: 5.0, fee: 'Contact For Fee', batchSize: 'Small batches', timings: ['Flexible Timings'], highlights: ['Conceptual teaching', 'Regular tests', 'Doubt sessions', 'Practice worksheets'], badge: 'Foundation', color: 'bg-noble-blue' },
  { id: 'std-8', title: 'Std 8th Coaching', category: 'Programs', subtitle: 'Concept Mastery', description: 'Concept-focused learning with regular assessments, doubt-solving sessions, and performance tracking to ensure steady academic progress.', subjects: ['Mathematics', 'Science', 'English'], duration: 'Academic Year', students: 'Enrolling Now', rating: 5.0, fee: 'Contact For Fee', batchSize: 'Small batches', timings: ['Flexible Timings'], highlights: ['Concept clarity', 'Weekly tests', 'Progress tracking', 'Study material'], badge: 'Popular', color: 'bg-emerald-600' },
  { id: 'std-9', title: 'Std 9th Coaching', category: 'Programs', subtitle: 'Advanced Preparation', description: 'Advanced preparation with detailed subject understanding, exam strategies, and comprehensive coverage of the academic curriculum.', subjects: ['Mathematics', 'Science', 'English'], duration: 'Academic Year', students: 'Enrolling Now', rating: 5.0, fee: 'Contact For Fee', batchSize: 'Small batches', timings: ['Flexible Timings'], highlights: ['Advanced prep', 'Mock tests', 'Expert guidance', 'Exam strategies'], badge: 'Advanced', color: 'bg-noble-navy' },
  { id: 'std-10', title: 'Std 10th Coaching', category: 'Programs', subtitle: 'Board Exam Focus', description: 'Board exam-focused preparation, revision programs, intensive practice sessions, and mock tests for academic excellence.', subjects: ['Mathematics', 'Science', 'English'], duration: 'Academic Year', students: 'Enrolling Now', rating: 5.0, fee: 'Contact For Fee', batchSize: 'Small batches', timings: ['Flexible Timings'], highlights: ['Board prep', 'Revision program', 'Practice sessions', 'Mock exams'], badge: 'Board Focus', color: 'bg-red-600' },
];
...
const Courses: React.FC = () => {
  ...
  return (
    <>
      <PageHero title="Our Courses" subtitle="Comprehensive coaching programs for Std 7th to Std 10th designed to build strong concepts and academic excellence." breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'Courses' }]} />
