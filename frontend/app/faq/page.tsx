...
const faqData = [
  { q: 'What coaching does Labbdis Academy offer?', a: 'Labbdis Academy provides coaching for students of Std 8th, 9th & 10th (State Board & CBSE) in Mathematics, Science, and English. Our programs focus on concept-based learning and academic excellence.' },
  { q: 'Where is Labbdis Academy located?', a: 'Labbdis Academy is located near Shreyas Cinema, Ghatkopar West, Mumbai, Maharashtra. We are easily accessible from all parts of Ghatkopar and surrounding areas.' },
...
const FAQ: React.FC = () => {
  ...
  return (
    <>
      <PageHero title="Frequently Asked Questions" subtitle="Find answers to common questions about Labbdis Academy, our coaching programs, admissions, and more." breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'FAQ' }]} />
