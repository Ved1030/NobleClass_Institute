...
const steps = [
  { step: '01', title: 'Submit Inquiry', desc: 'Fill the online inquiry form or visit our center in Ghatkopar West.', icon: FileText },
...
const Admissions: React.FC = () => {
  return (
    <>
      <PageHero title="Admissions" subtitle="Begin your academic journey with Labbdhi's Academy. Admissions open for Std 8th, 9th & 10th (State Board & CBSE). Limited seats available." breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'Admissions' }]} />
