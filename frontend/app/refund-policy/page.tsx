    ...
    <>
      ...
      <SectionWrapper className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-noble-navy/70 mb-6">At VS Tutorials, we strive to ensure complete satisfaction with our programs. However, we understand that circumstances may change, and we have established a fair refund policy.</p>
