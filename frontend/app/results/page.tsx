...
const toppers2025 = [
  { name: 'Aryan Shah', score: '98.4%', exam: 'SSC Board 2025', rank: '1st in School', image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face', subject: 'All Subjects' },
  { name: 'Sneha Kulkarni', score: '97.8%', exam: 'SSC Board 2025', rank: '2nd in School', image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop&crop=face', subject: 'All Subjects' },
  { name: 'Rohan Desai', score: '97.2%', exam: 'SSC Board 2025', rank: '3rd in School', image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face', subject: 'All Subjects' },
  { name: 'Kavya Nair', score: '96.6%', exam: 'SSC Board 2025', rank: '4th in School', image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&h=100&fit=crop&crop=face', subject: 'All Subjects' },
  { name: 'Rahul Mehta', score: '97.2 %ile', exam: 'JEE Mains 2025', rank: 'AIR 1240', image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face', subject: 'PCM' },
  { name: 'Priya Sharma', score: '680/720', exam: 'NEET 2025', rank: 'AIR 890', image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=100&h=100&fit=crop&crop=face', subject: 'PCB' },
];

const performanceData = [
  { year: '2020', ssc: 94, jee: 85, neet: 82 },
  { year: '2021', ssc: 95, jee: 87, neet: 85 },
  { year: '2022', ssc: 96, jee: 89, neet: 88 },
  { year: '2023', ssc: 97, jee: 91, neet: 90 },
  { year: '2024', ssc: 97.5, jee: 93, neet: 92 },
  { year: '2025', ssc: 98, jee: 95, neet: 94 },
];

const stats = [
  { label: 'SSC Pass Rate', value: 98, suffix: '%', icon: TrendingUp, color: '#005DAA' },
  { label: 'JEE Qualifiers', value: 200, suffix: '+', icon: GraduationCap, color: '#C62828' },
  { label: 'NEET Qualifiers', value: 150, suffix: '+', icon: HeartPulse, color: '#16A34A' },
  { label: 'School Toppers', value: 50, suffix: '+', icon: Trophy, color: '#F4B400' },
];

const Results: React.FC = () => {
  return (
    <>
      <PageHero title="Results & Achievements" subtitle="A legacy of academic excellence — our students consistently achieve top ranks in SSC, JEE, and NEET examinations." breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'Results' }]} />
      ...
      <div className="bg-[#F8FAFC] pt-16 pb-0">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="font-semibold text-noble-blue/70 text-base tracking-wide">Academic Excellence Since 2010</span>
      ...
      <SectionWrapper className="py-20 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[{ title: '12 Students', subtitle: 'Scored 95%+ in SSC 2025', icon: Star }, { title: '5 Students', subtitle: 'Cleared JEE Advanced 2025', icon: Trophy }, { title: '8 Students', subtitle: 'NEET Score 650+', icon: Award }, { title: '100%', subtitle: 'Class 10 Pass Rate (2025)', icon: TrendingUp }].map((item, i) => (
