...
const Results: React.FC = () => {
  return (
    <>
      <PageHero title="Results & Achievements" subtitle="Celebrating academic excellence and outstanding achievements of our students at Labbdis Academy." breadcrumbs={[{ label: 'Home', path: '/' }, { label: 'Results' }]} />
