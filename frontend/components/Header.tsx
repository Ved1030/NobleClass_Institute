    ...
    <>
      <div className={`hidden lg:flex fixed top-0 left-0 right-0 z-50 bg-noble-blue text-white text-xs h-[40px] transition-all duration-300 ${isScrolled ? 'shadow-md' : ''}`}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between w-full">
          <span>Trusted Coaching Institute in Ghatkopar Since 2010</span>
          <div className="flex items-center gap-4">
            <a href="tel:+919820023732" className="hover:text-white/80 transition-colors flex items-center gap-1">
              <Phone className="w-3 h-3" /> 9820023732
            </a>
            <a href="tel:+919930890499" className="hover:text-white/80 transition-colors flex items-center gap-1">
              <Phone className="w-3 h-3" /> 9930890499
            </a>
          </div>
        </div>
      </div>
            ...
            >
              <div className="px-4 py-4 space-y-1">
                ...
                <div className="border-t border-gray-100 pt-3 mt-3 space-y-2">
                  <a href="tel:+919820023732" className="flex items-center gap-2 px-4 py-2.5 text-sm text-noble-dark/70 hover:bg-noble-light rounded-xl">
                    <Phone className="w-4 h-4 text-noble-blue" /> 9820023732
                  </a>
                  <a href="tel:+919930890499" className="flex items-center gap-2 px-4 py-2.5 text-sm text-noble-dark/70 hover:bg-noble-light rounded-xl">
                    <Phone className="w-4 h-4 text-noble-blue" /> 9930890499
                  </a>
                  <Link
                    href="/contact"
