...
const WhatsAppButton: React.FC = () => {
  ...
  // TODO: Owner to update WhatsApp number
  const whatsappUrl = `https://wa.me/919769113425?text=${encodeURIComponent('Hello! I would like to know more about VS Tutorials.')}`;
