    ...
    <footer className="bg-noble-dark text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          <div className="sm:col-span-2 lg:col-span-2">
            <Link href="/" prefetch className="flex items-center gap-3 mb-4">
              ...
              <div>
                <span className="font-heading font-bold text-xl text-white">Labbdis Academy</span>
            ...
            <p className="text-white/50 text-sm leading-relaxed mb-6 max-w-sm">
              Labbdis Academy has been guiding students since 2007 in Ghatkopar West, Mumbai, providing expert coaching for Std 8th, 9th & 10th (State Board & CBSE) with concept-based learning, personal attention, and academic excellence.
            </p>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-xs">&copy; {new Date().getFullYear()} Labbdis Academy. All rights reserved.</p>
